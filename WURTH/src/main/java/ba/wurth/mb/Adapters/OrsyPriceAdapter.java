...
public class OrsyPriceAdapter extends ArrayAdapter<JSONObject>
{
    ...
    public OrsyPriceAdapter(Context context, int textViewResourceId, JSONArray objects, Fragment f)
    {
        ...
        try {
            ...
            if (mCursor != null) {
                ...
                if (mCursor.moveToFirst()) {
                    ...
                    ViewHolderPricelist.litSupTotal.setText(element.getString("Quantity"));
                    ViewHolderPricelist.litSubTotal.setText(element.getString("Price"));
                }
            }
        } catch (JSONException e) {
            e.printStackTrace();
