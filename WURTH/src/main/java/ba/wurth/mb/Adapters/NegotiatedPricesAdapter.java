...
public class NegotiatedPricesAdapter extends ArrayAdapter<JSONObject>
{
    ...
    public NegotiatedPricesAdapter(Context context, int textViewResourceId, JSONArray objects, Fragment f)
    {
    ...
    public View getView(final int position, View v, ViewGroup parent)
    {
        try {
            ...
            try {
                ...
                wurthMB.AddError("NegotiatedPricesAdapter", e.getMessage(), e);
            }
        } catch (Exception e) {
            wurthMB.AddError("NegotiatedPricesAdapter", e.getMessage(), e);
        }
